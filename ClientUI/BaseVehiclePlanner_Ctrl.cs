...
namespace VehiclePlanner
{
	...
	public partial class BaseVehiclePlanner_Ctrl : Form, ICtVersion, IDataDisplay<IBaseVehiclePlanner>, IDataDisplay<IBaseITSController>
	{
		...
		/// </summary>
		internal void AutoReport() => Task.Run(() => rVehiclePlanner.Controller.AutoReport(!rVehiclePlanner.Controller.IsAutoReport));
		...
		protected virtual string SelectFile(string fileList)
		{
