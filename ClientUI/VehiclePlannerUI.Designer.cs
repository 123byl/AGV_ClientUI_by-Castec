...
namespace VehiclePlanner {
    partial class VehiclePlannerUI {
        ...
        private void InitializeComponent() {
            ...
            this.tslbAccessLv = new BindableToolStripStatusLabel();
            this.tslbInterval = new BindableToolStripStatusLabel();
            this.tslbUserName = new BindableToolStripStatusLabel();
            this.tslbSpring = new BindableToolStripStatusLabel();
            this.tslbHostIP = new BindableToolStripStatusLabel();
            this.tslbStatus = new BindableToolStripStatusLabel();
            this.tslbBattery = new BindableToolStripStatusLabel();
            ...
            this.systemToolStripMenuItem = new BindableToolStripMenuItem();
            this.miLogin = new BindableToolStripMenuItem();
            this.miUserManager = new BindableToolStripMenuItem();
            this.miExit = new BindableToolStripMenuItem();
            this.viewToolStripMenuItem = new BindableToolStripMenuItem();
            this.miMapGL = new BindableToolStripMenuItem();
            this.miTesting = new BindableToolStripMenuItem();
            this.miGoalSetting = new BindableToolStripMenuItem();
            this.miConsole = new BindableToolStripMenuItem();
            this.miToolBox = new BindableToolStripMenuItem();
            this.miMapInsert = new BindableToolStripMenuItem();
            this.miMotionController = new BindableToolStripMenuItem();
            this.miHelp = new BindableToolStripMenuItem();
            this.miAbout = new BindableToolStripMenuItem();
            this.testToolStripMenuItem = new BindableToolStripMenuItem();
            this.miBypass = new BindableToolStripMenuItem();
            this.miBypassSocket = new BindableToolStripMenuItem();
            this.miLoadFile = new BindableToolStripMenuItem();
            this.miServer = new BindableToolStripMenuItem();
        ...
        protected BindableToolStripStatusLabel tslbBattery;
        protected System.Windows.Forms.ToolStripProgressBar tsprgBattery;
        private System.Windows.Forms.MenuStrip menuStrip1;
        private BindableToolStripMenuItem viewToolStripMenuItem;
        private BindableToolStripMenuItem miMapGL;
        private BindableToolStripMenuItem miTesting;
        private BindableToolStripMenuItem miGoalSetting;
        private BindableToolStripMenuItem miConsole;
        private BindableToolStripMenuItem systemToolStripMenuItem;
        private BindableToolStripMenuItem miLogin;
        private BindableToolStripMenuItem miExit;
        private BindableToolStripMenuItem miHelp;
        private BindableToolStripMenuItem miAbout;
        private BindableToolStripMenuItem miUserManager;
        private BindableToolStripStatusLabel tslbAccessLv;
        private BindableToolStripStatusLabel tslbUserName;
        private BindableToolStripStatusLabel tslbSpring;
        private BindableToolStripStatusLabel tslbInterval;
        private BindableToolStripStatusLabel toolStripStatusLabel1;
        protected BindableToolStripStatusLabel tslbStatus;
        private BindableToolStripStatusLabel tslbHostIP;
        private BindableToolStripMenuItem miBypass;
        private BindableToolStripMenuItem miBypassSocket;
        private BindableToolStripMenuItem miLoadFile;
        private BindableToolStripMenuItem miServer;
        private BindableToolStripMenuItem testToolStripMenuItem;
        private BindableToolStripMenuItem miToolBox;
        private BindableToolStripMenuItem miMapInsert;
        private BindableToolStripMenuItem miMotionController;
    }
}