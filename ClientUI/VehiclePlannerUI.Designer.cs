...
namespace VehiclePlanner {
    partial class VehiclePlannerUI {
        ...
        private void InitializeComponent() {
            ...
            this.tslbAccessLv = new Bindable.ToolStripStatusLabel();
            this.tslbInterval = new Bindable.ToolStripStatusLabel();
            this.tslbUserName = new Bindable.ToolStripStatusLabel();
            this.tslbSpring = new Bindable.ToolStripStatusLabel();
            this.tslbHostIP = new Bindable.ToolStripStatusLabel();
            this.tslbStatus = new Bindable.ToolStripStatusLabel();
            this.tslbBattery = new Bindable.ToolStripStatusLabel();
            this.tsprgBattery = new System.Windows.Forms.ToolStripProgressBar();
            this.toolStripStatusLabel1 = new Bindable.ToolStripStatusLabel();
            this.menuStrip1 = new System.Windows.Forms.MenuStrip();
            this.systemToolStripMenuItem = new Bindable.ToolStripMenuItem();
            this.miLogin = new Bindable.ToolStripMenuItem();
            this.miUserManager = new Bindable.ToolStripMenuItem();
            this.miExit = new Bindable.ToolStripMenuItem();
            this.viewToolStripMenuItem = new Bindable.ToolStripMenuItem();
            this.miMapGL = new Bindable.ToolStripMenuItem();
            this.miTesting = new Bindable.ToolStripMenuItem();
            this.miGoalSetting = new Bindable.ToolStripMenuItem();
            this.miConsole = new Bindable.ToolStripMenuItem();
            this.miToolBox = new Bindable.ToolStripMenuItem();
            this.miMapInsert = new Bindable.ToolStripMenuItem();
            this.miMotionController = new Bindable.ToolStripMenuItem();
            this.miHelp = new Bindable.ToolStripMenuItem();
            this.miAbout = new Bindable.ToolStripMenuItem();
            this.testToolStripMenuItem = new Bindable.ToolStripMenuItem();
            this.miBypass = new Bindable.ToolStripMenuItem();
            this.miBypassSocket = new Bindable.ToolStripMenuItem();
            this.miLoadFile = new Bindable.ToolStripMenuItem();
            this.miServer = new Bindable.ToolStripMenuItem();
