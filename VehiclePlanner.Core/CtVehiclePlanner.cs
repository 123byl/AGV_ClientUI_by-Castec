	...
	public partial class BaseVehiclePlanner : IBaseVehiclePlanner
	{
		...
		public void SaveMap()
		{
			if (!string.IsNullOrEmpty(CurMapPath))
			{
				...
				var msg = MessageBox.Show($"Do you want to overwrite file in {CurMapPath}", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
			...
			if (Ans == DialogResult.OK) SaveMap(saveFile.FileName);
		}
