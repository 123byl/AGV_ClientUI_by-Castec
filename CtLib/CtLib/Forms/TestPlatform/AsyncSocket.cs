...
namespace CtLib.Forms.TestPlatform {
    ...
    public partial class Test_AsyncSockets : Form {
        ...
        void mSocket_OnSocketEvents(object sender, CtAsyncSocket.SocketEventArgs e) {
            switch (e.Event) {
                case CtAsyncSocket.SocketEvents.CONNECTED_WITH_SERVER:
                    CtAsyncSocket.ConnectInfo infoClient = e.Value as CtAsyncSocket.ConnectInfo;
                ...
                case CtAsyncSocket.SocketEvents.CLIENT_CONNECTED:
                    CtAsyncSocket.ConnectInfo infoSrv = e.Value as CtAsyncSocket.ConnectInfo;
                ...
                case CtAsyncSocket.SocketEvents.DATA_RECEIVED:
                    CtAsyncSocket.DataInfo data = e.Value as CtAsyncSocket.DataInfo;
                ...
                case CtAsyncSocket.SocketEvents.LISTEN:
                    CtAsyncSocket.ConnectInfo infoListen = e.Value as CtAsyncSocket.ConnectInfo;
        ...
        private void btnConnect_Click(object sender, EventArgs e) {
            ...
            try {
                if (CtConvert.CBool(btnConnect.Tag)) {
                    ...
                    mSocket = new CtAsyncSocket(mDataType);
                    mSocket.OnSocketEvents += mSocket_OnSocketEvents;
                    if (cbMode.SelectedIndex == 0) {
