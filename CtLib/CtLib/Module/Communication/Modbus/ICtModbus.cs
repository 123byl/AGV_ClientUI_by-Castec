...
namespace CtLib.Module.Modbus {
    ...
    interface ICtModbus {
        ...
        Stat ReadCoilStatus(byte devID, ushort addr, ushort coilCount, out List<bool> state);
        ...
        Stat ReadHoldingRegister(byte devID, ushort addr, ushort regCount, out List<byte> value);
        ...
        /// <returns>Status Code</returns>
        Stat ReadInputStatus(byte devID, ushort addr, ushort bitCount, out List<bool> value);
        ...
        /// <returns>Status Code</returns>
        Stat ReadInputRegisters(byte devID, ushort addr, ushort regCount, out List<byte> value);
        ...
        /// <returns>Status Code</returns>
        Stat WriteSingleCoil(byte devID, ushort addr, bool value, out List<byte> result);
        ...
        /// <param name="result">回傳之結果</param>
        /// <returns>Status Code</returns>
        Stat WriteSingleRegister(byte devID, ushort addr, ushort value, out List<byte> result);
        ...
        /// <param name="result">回傳之結果</param>
        /// <returns>Status Code</returns>
        Stat WriteMultiCoils(byte devID, ushort addr, List<bool> value, out List<byte> result);
        ...
        /// <param name="result">回傳之結果</param>
        /// <returns>Status Code</returns>
        Stat WriteMultiRegisters(byte devID, ushort addr, List<ushort> data, out List<byte> result);

        /// <summary>[FC05] 寫入指定裝置的單一 bit 狀態，不等待回傳結果  [Force Single Coil]</summary>
        /// <param name="devID">指定裝置的局號</param>
        /// <param name="addr">IO Address</param>
        /// <param name="value">欲寫入之狀態  (<see langword="true"/>)ON (<see langword="false"/>)OFF</param>
        /// <returns>Status Code</returns>
        Stat WriteSingleCoil(byte devID, ushort addr, bool value);

        /// <summary>[FC06] 寫入指定裝置的單一 Register 數值，不等待回傳結果  [Preset Single Register]</summary>
        /// <param name="devID">指定裝置的局號</param>
        /// <param name="addr">Register Address</param>
        /// <param name="value">欲寫入之數值</param>
        /// <returns>Status Code</returns>
        Stat WriteSingleRegister(byte devID, ushort addr, ushort value);

        /// <summary>[FC15] 寫入指定裝置的連續 Bit 狀態，不等待回傳結果  [Force Multi Coils]</summary>
        /// <param name="devID">指定裝置的局號</param>
        /// <param name="addr">起始 IO Address</param>
        /// <param name="value">欲寫入之狀態</param>
        /// <returns>Status Code</returns>
        Stat WriteMultiCoils(byte devID, ushort addr, List<bool> value);

        /// <summary>[FC16] 寫入指定裝置的連續 Register 數值，不等待回傳結果，  [Preset Multi Registers]</summary>
        /// <param name="devID">指定裝置的局號</param>
        /// <param name="addr">起始 Register Address</param>
        /// <param name="data">欲寫入的資料</param>
        /// <returns>Status Code</returns>
        Stat WriteMultiRegisters(byte devID, ushort addr, List<ushort> data);
        ...
        /// <summary>[FC05] 寫入單一 bit 狀態，不等待回傳結果  [Force Single Coil]</summary>
        /// <param name="addr">IO Address</param>
        /// <param name="value">欲寫入之狀態  (<see langword="true"/>)ON (<see langword="false"/>)OFF</param>
        /// <returns>Status Code</returns>
        Stat WriteSingleCoil(ushort addr, bool value);

        /// <summary>[FC06] 寫入單一 Register 數值，不等待回傳結果  [Preset Single Register]</summary>
        /// <param name="addr">Register Address</param>
        /// <param name="value">欲寫入之數值</param>
        /// <returns>Status Code</returns>
        Stat WriteSingleRegister(ushort addr, ushort value);

        /// <summary>[FC15] 寫入連續 Bit 狀態，不等待回傳結果  [Force Multi Coils]</summary>
        /// <param name="addr">起始 IO Address</param>
        /// <param name="value">欲寫入之狀態</param>
        /// <returns>Status Code</returns>
        Stat WriteMultiCoils(ushort addr, List<bool> value);

        /// <summary>[FC16] 寫入連續 Register 數值，不等待回傳結果，  [Preset Multi Registers]</summary>
        /// <param name="addr">起始 Register Address</param>
        /// <param name="data">欲寫入的資料</param>
        /// <returns>Status Code</returns>
        Stat WriteMultiRegisters(ushort addr, List<ushort> data);
    }
}
