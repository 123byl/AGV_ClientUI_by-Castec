...
namespace CtLib.Library {
	...
	public static class CtConst {
		...
		/// </code></remarks>
		public static CtVersion Version { get { return new CtVersion(1, 0, 3, "2015/02/11", "Ahern Kuo"); } }
		...
		/// <param name="max">最大數值，範圍為 "0 ~ 此數值"</param>
		/// <returns>亂數</returns>
		/// <example>
		/// 取得 0 ~ 100 之亂數
		/// <code language="C#">
		...
		/// <param name="max">最大數值，範圍為 "min ~ 此數值"</param>
		/// <param name="min">最小數值，範圍為 "此數值 ~ max"</param>
		/// <returns>亂數</returns>
		/// <example><code language="C#">
